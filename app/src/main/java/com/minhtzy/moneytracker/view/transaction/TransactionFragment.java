...
import com.minhtzy.moneytracker.view.transaction.adapter.TransactionPagerAdapter;
    ...
    private void addEvents() {
        mFabAddTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.minhtzy.moneytracker.view.transaction.AddTransactionActivity.class);
