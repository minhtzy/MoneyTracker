...
public class TransactionsDAOImpl implements com.minhtzy.moneytracker.dataaccess.ITransactionsDAO {
    ...
    com.minhtzy.moneytracker.dataaccess.MoneyTrackerDBHelper dbHelper;
    com.minhtzy.moneytracker.dataaccess.ICategoriesDAO iCategoriesDAO;
    com.minhtzy.moneytracker.dataaccess.IWalletsDAO iWalletsDAO;

    public TransactionsDAOImpl(Context context) {
        dbHelper = new com.minhtzy.moneytracker.dataaccess.MoneyTrackerDBHelper(context);
        iCategoriesDAO = new com.minhtzy.moneytracker.dataaccess.CategoriesDAOImpl(context);
        iWalletsDAO = new com.minhtzy.moneytracker.dataaccess.WalletsDAOImpl(context);
    }
    // Transaction
