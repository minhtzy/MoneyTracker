...
public class Fragment_Statistical_Tab1 extends Fragment implements SeekBar.OnSeekBarChangeListener, OnChartValueSelectedListener {
    View view;
    ...
    public Fragment_Statistical_Tab1(){}
