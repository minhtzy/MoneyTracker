...
public class ListTransactionAdapter extends SectionedBaseAdapter {

    private Context mContext;
    private List<Pair<Date,List<Transaction>>> mItems;

    public ListTransactionAdapter(List<Pair<Date,List<Transaction>>> items) {
        mItems = items;
    }
    public ListTransactionAdapter(Context context, List<Pair<Date,List<Transaction>>> items) {
        mContext = context;
        mItems = items;
    }
